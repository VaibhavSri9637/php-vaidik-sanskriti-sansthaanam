...
<head>
    <title>About Us - मात्रुशिक्षा</title>
    <meta name="description" content="Maatrushiksha ke baare me jaaniye. Hindi sanskriti ko badhaane ke hamaare uddeshya ko jaaniye or hume apna sayhog dijie.">
    <link rel="canonical" href="https://www.maatrushiksha.org/about" />
...
<body>
    ...
    <div class="pages-heading-container" id="about-heading">
    ...
    <div class="pages-content-container lato-regular" id="about-content">
        <p>
        ...
        $(document).ready(function() {
            $("#vision-switch").click(function() {
                if ($("#vision-switch").is(':checked')) {
                    ...
                    $("#acknowledgement-content>p").html(`Vedic Sanskriti Sansthanam would like to sincerely acknowledge and thank the following without whom this work would not be possible. The initial data for this site is a redistribution of the remarkable work of an English gentleman, S. W. Fallon (1817–80): A dictionary of Hindustani proverbs, including many Marwari, Panjabi, Maggah, Bhojpuri and Tirhuti proverbs, sayings, emblems, aphorisms, maxims and similes; edited and revised by R. C. Temple and Lala Faqir Chand. It was printed in 1886 at Banaras (Varanasi). Indian linguistic cultural has greatly expanded since then and we thank in advance for our contemporary contributors. Vaibhav Srivastava has developed this website.We thank him for his excellent work carried out in an economical, timely and dedicated manner. The arduous task of data entry was done by Harish Kiroula and Rajnandan Keshri under the able supervision of Surendra Tripathi - we are grateful
                                    for their tireless efforts.<br />Last but not the least, women in our lives are the spirit that gives us inspiration and strength.Words are not sufficient today to thank my dear mother and my sweet wife without whom nothing would have materialized!<br /><br />
                                    Shubham astu!<br /><br />
