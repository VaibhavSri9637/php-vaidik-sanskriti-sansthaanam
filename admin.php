...
if (isset($_POST["delete-contribution"])) {
    ...
    if (mysqli_query($conn, $sqlcontributiondelete)) {
        ...
        $newcontributionresponse = 'Congratulations! Your idiom has been deleted.';
    } else {
        $newcontributionresponse = 'I am sorry, there was some error in deleting your idiom. Please try again.';
    }
    $loggedin = true;
}
?>
